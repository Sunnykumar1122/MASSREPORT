...
async def handle_start(bot:Client, message:Message):
    ...
    Btn = [
        ...
        [InlineKeyboardButton(text='📰𝖴𝖯𝖣𝖠𝖳𝖤🗞️', url='https://t.me/DEMON_BOT_UPDATE'), InlineKeyboardButton(text='🤖𝖡𝖮𝖳 𝖨𝖭𝖥𝖮ℹ️', callback_data='about')],
        [InlineKeyboardButton(text='🧑‍💻ROLEX⌨️', url='https://t.me/ll_ROLEX_lll')]
        ]
